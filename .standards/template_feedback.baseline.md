...
- `foundry_unify/path/to/file.ext`
...
`foundry_unify/.github/workflows/`.

**Affected Files**:
- `foundry_unify/.github/workflows/ci.yml`
- `foundry_unify/.github/workflows/release.yml`
- `foundry_unify/.github/workflows/docs.yml`
