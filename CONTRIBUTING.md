# Contributing to Foundry Unify

Thank you for your interest in contributing to Foundry Unify! This document provides guidelines and instructions for contributing to the project.
...
import pytest
from pathlib import Path
from foundry_unify.core import YourModule
...
- **General Questions**: Open a [GitHub Discussion](https://github.com/ByronWilliamsCPA/Unify/discussions)
- **Bug Reports**: Open a [GitHub Issue](https://github.com/ByronWilliamsCPA/Unify/issues)
...
Thank you for contributing to Foundry Unify!
