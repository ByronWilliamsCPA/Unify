...
wget https://github.com/ByronWilliamsCPA/foundry_unify/releases/download/v1.0.0/package.whl
wget https://github.com/ByronWilliamsCPA/foundry_unify/releases/download/v1.0.0/package.whl.sig
wget https://github.com/ByronWilliamsCPA/foundry_unify/releases/download/v1.0.0/package.whl.pem

# Verify signature
cosign verify-blob \
  --certificate package.whl.pem \
  --signature package.whl.sig \
  --certificate-identity-regexp="https://github.com/ByronWilliamsCPA/foundry_unify" \
...
wget https://github.com/ByronWilliamsCPA/foundry_unify/releases/download/v1.0.0/attestation.intoto.jsonl

# Verify with slsa-verifier
slsa-verifier verify-artifact package.whl \
  --provenance-path attestation.intoto.jsonl \
  --source-uri github.com/ByronWilliamsCPA/foundry_unify
```
...
1. Go to: `https://github.com/ByronWilliamsCPA/foundry_unify/settings/branches`
...
**General Issues**: [GitHub Issues](https://github.com/ByronWilliamsCPA/Unify/issues)
