...
docker build -t foundry_unify .  # Build production image
```
...
```python
from foundry_unify.middleware.correlation import (
    set_correlation_id,
...
class Settings(BaseSettings):
    project_name: str = "Foundry Unify"
...
../foundry_unify-worktrees/

# Quick reference commands
git worktree add ../foundry_unify-worktrees/feature-name -b feature/feature-name
git worktree add ../foundry_unify-worktrees/pr-42 origin/feature/pr-branch
git worktree list
git worktree remove ../foundry_unify-worktrees/feature-name
```
