...
class UnionSyntaxVisitor(ast.NodeVisitor):
    ...
    def visit_BinOp(self, node: ast.BinOp) -> None:  # noqa: N802 -- ast.NodeVisitor requires PascalCase visit methods
    ...
    def visit_AnnAssign(self, node: ast.AnnAssign) -> None:  # noqa: N802 -- ast.NodeVisitor requires PascalCase visit methods
        """Visit annotated assignments."""
        if node.annotation:
            self.visit(node.annotation)
        self.generic_visit(node)

    def visit_FunctionDef(self, node: ast.FunctionDef) -> None:  # noqa: N802 -- ast.NodeVisitor requires PascalCase visit methods
    ...
    def visit_AsyncFunctionDef(self, node: ast.AsyncFunctionDef) -> None:  # noqa: N802 -- ast.NodeVisitor requires PascalCase visit methods
