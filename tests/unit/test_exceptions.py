...
Foundry Unify exception hierarchy, covering:
...
class TestProjectBaseError:
    ...
    def test_basic_initialization(self) -> None:
        ...
        from foundry_unify.core.exceptions import ProjectBaseError
...
class TestConfigurationError:
    ...
    def test_initialization(self) -> None:
        ...
        from foundry_unify.core.exceptions import ConfigurationError
...
class TestResourceNotFoundError:
    ...
    def test_basic_initialization(self) -> None:
        ...
        from foundry_unify.core.exceptions import ResourceNotFoundError
...
class TestAuthenticationError:
    ...
    def test_default_message(self) -> None:
        ...
        from foundry_unify.core.exceptions import AuthenticationError
...
class TestAuthorizationError:
    ...
    def test_default_message(self) -> None:
        """Verify default message is used when not provided."""
        from foundry_unify.core.exceptions import AuthorizationError
...
class TestExternalServiceError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from foundry_unify.core.exceptions import ExternalServiceError
...
class TestAPIError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from foundry_unify.core.exceptions import APIError
...
class TestDatabaseError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from foundry_unify.core.exceptions import DatabaseError
...
class TestBusinessLogicError:
    ...
    def test_default_error_code(self) -> None:
        """Verify default error code is set."""
        from foundry_unify.core.exceptions import BusinessLogicError
...
class TestModuleExports:
    ...
    def test_all_exceptions_exported(self) -> None:
        ...
        from foundry_unify.core import exceptions
