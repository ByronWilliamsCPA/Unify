"""Example tests demonstrating best practices for Foundry Unify.
...
class TestPackageInitialization:
    ...
    def test_package_author_exists(self) -> None:
        ...
        """
        from foundry_unify import __author__, __email__
...
class TestCLI:
    ...
    def test_cli_has_version(self) -> None:
        ...
        """
        from foundry_unify.cli import cli
    ...
    def test_cli_config_command(self) -> None:
        ...
        assert "Project: Foundry Unify" in result.output
    ...
    def test_cli_context_setup(self) -> None:
        ...
        assert result.exit_code == 0
        assert "Foundry Unify" in result.output
    ...
    def test_cli_hello_error_handling(self) -> None:
        ...
        with patch("foundry_unify.cli.logger") as mock_logger:
